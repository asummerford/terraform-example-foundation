...
// Example variable to demonstrate partial coverage
const isReady = Math.random() > 0.5;
console.log('partialCoverage', isReady);

// Green indicators means that Quokka executed all statements
// on a line of code
// Example: Replace with a real condition or remove if not needed
const shouldLogNoCoverage = false;
if (shouldLogNoCoverage) {
